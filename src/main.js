...
function createPlanet(){
  const texture = new THREE.ImageUtils.loadTexture("./textures/moon_safemoon.png")
  ...
  var moonGeometry = new THREE.IcosahedronGeometry(530, 5 );
...
function animate(){
  ...
  var currentSeconds = Date.now();
   ...
   moon.rotation.y = currentSeconds * .0002;
  controls.update();
}

function init(){
  scene = new THREE.Scene();
  //scene.background = 0x1d836a;
